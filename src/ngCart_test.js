  ...
  describe('CartController', function() {
    ...
    describe('$scope.ngCart', function() {
      ...
      describe('ngCart', function() {
        ...
        it('Discount should be set', function() {
          expect($scope.ngCart.setDiscount({amount:5,type: 'percent'}, false)).toEqual({amount:5,type: 'percent'});
        });

        it('Discount should be set', function() {
          $scope.ngCart.setDiscount({amount:5,type: 'percent'}, false);
          expect($scope.ngCart.getDiscount()).toEqual({amount:5,type: 'percent'});
        });
        ...
        it('Have correct totalCost with 5 dollar discount', function() {
          $scope.ngCart.setDiscount({amount: 5, type: 'dollar'}, false);
          expect($scope.ngCart.totalCost()).toEqual(931.56);
        });

        it('Have correct totalCost with 10 percent off discount', function() {
          $scope.ngCart.setDiscount({amount: 10, type: 'percent'}, false);
          expect($scope.ngCart.totalCost()).toEqual(844.5);
        });
