...
.service('cart', ['$rootScope', '$window', 'ngCartItem', 'ngCartStore', 'store', function ($rootScope, $window, ngCartItem, ngCartStore, store) {
  ...
  this.addItem = function (id, name, price, quantity, data, callback) {
    ...
    if (typeof inCart === 'object'){
      ...
      // in the case of same product but a product variant we might want to also update the data and price
...
.directive('ngcartAddtocart', ['$ngCart', '$log', function($ngCart, $log){
  return {
    restrict : 'E',
    ...
    templateUrl: function(element, attrs) {
      if ( typeof attrs.templateUrl == 'undefined' ) {
        ...
        if (typeof attrs.buttonText == 'undefined'){
          $log.warn('Custom template might require button-text attribute')
        }
